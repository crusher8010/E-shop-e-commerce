...
const fetchdata = (order, val, page) => {
    if (val != "") {
        return axios.get(
          `https://ani-mock-server-app.onrender.com/Childrens?_sort=offer_price&_order=${order}&type=${val}&_page=${page}&_limit=6`
        );
    } else {
        return axios.get(
          `https://ani-mock-server-app.onrender.com/Childrens?_sort=offer_price&_order=${order}&_page=${page}&_limit=6`
        );
    }
}
